...
tdcli.sendMessage(msg.to.id, 0, 1, "♼￤ تم ارسال رسالتك للمطور ", 1, '')
...
----------------------
local su = {
"نہعہمہ حہبہيہبہيہ آلمہطہوٌر 🌝❤",
"يابعد روح "..bot_name.." 😘❤️",
"هہلآ مہطہوٌريہ ءآمہرنہيہ 🤓"
}
local  ss97 = {
"هہآ حہيہآتہيہ😻",
"عہيہوٌنہيہ 🦁",
...
"هہآ حہبہيہ 😍",
"هہآ عہمہريہ 🦁📯",
"اجہيہتہ كہآفہيہ لتہصہيہحہ 🌚👌",
"هہيہآتہنہيہ آجہيہتہ 🌚❤️",
"نہعہمہ حہبہيہ 😎",
"هہوٌهہ غہيہر يہسہكہتہ هہآ شہتہريہد 😷",
"احہجہيہ بہسہرعہهہ شہتہريہد 😤",
"هہآ يہكہلبہيہ ❤️",
"همہ صہآحہوٌ عہليہهہ رآحہ آبہدل آسہمہيہ 😡",
"لكہ فہدآكہ "..bot_name.." حہبہيہبہيہ آنہتہهہ مہحہ 💋",
"دآشہربہ جہآيہ تہعہآل غہيہر وٌكہتہ 😌",
"كہوٌل حہبہيہ 😍",
"احجہيہ فہضہنہيہ شہرآيہد وٌلآضہل آطہبہقہ بہرآسہيہ تہرآ سہوٌآلفہكہ بہآيہخہهہ 😒😏",
"اشتہعہلوٌ آهہل "..bot_name.." شہتہريہد 😠",
"بہوٌوٌوٌوٌ👻 هہآ هہآ شہفہتہكہ  لآتہحہلفہ 😂",
"طہآلعہ مہمہوٌجہوٌد 😒",
"هآ شہنہوٌ آكہوٌ حہآتہهہ بہلكہروٌبہ وٌصہحہتہنہيہ 😍💕",
"انہتہ مہوٌ قہبہل يہوٌمہيہنہ غہلطہتہ عہليہهہ?? 😒",
"رآجہعہ المكہتہبہ حہبہيہ عبہآلكہ "..bot_name.." سہهہل تحہجہيہ ويہا 😒",
"يہآعہيہوٌنہ "..bot_name.." ءآمہرنہيہ 😍",
"لكہ دبہدل مہلآبہسہيہ آطہلعہ بہرآا 😵😡 نہآسہ متہسہتہحہيہ",
"سويہتہ هہوٌآيہ شہغہلآتہ بہحہيہآتہ بہسہ عہمہريہ كہلهہ مہكہلتہ لحہد آنہجہبہ 😑",
"مشہغہوٌل وٌيہهہ ضہلعہتہيہ  ☺️",
"مازآ تہريہد مہنہهہ 😌🍃",

}
local bs = {
"مہآبہوٌسہ 🌚💔",
"• مِْٰ̲ـﮧحِْٰحِْٰ̲ـﮧحِْٰحِْٰ̲ـﮧحِْٰہ😻👄ֆ️",
"الوٌجہهہ مہيہسہآعہد 😐✋",
"• مِْٰ̲ـﮧحِْٰحِْٰ̲ـﮧحِْٰحِْٰ̲ـﮧحِْٰہهہ😻👄ֆ",
}
local ns = {
"هہلوٌآتہ عہمہريہ 🙊💫",
"هْـٌلوٌآآتہ😻☝️",
"هلآوٌآآآآتہ نوٌرتہ/يہ ❤️🙈",
"هلوٌآآآتہ 😊🌹",
}
local sh = {
"اهلآ عہزيہزيہ آلمہطہوٌر 😽❤️",
"هلوٌآتہ نہوٌرتہ مہطہوٌريہ😍",
}
...
if string.match(ww, 'علي')  or  string.match(ww, 'علش') or  string.match(ww, 'علاوي') or  string.match(ww, 'علو')  or string.match(ww, 'علوش') then
return true
else
return false
end
